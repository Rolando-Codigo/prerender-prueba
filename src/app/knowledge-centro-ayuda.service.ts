...
import { KnowledgeCentroAyudaResponse } from './knowledge-centro-ayuda-response';
...
export class KnowledgeCentroAyudaService {
  ...
  // private _URL = '/us-central';
  private _URL = 'https://us-central1-adquirencia-domicilio.cloudfunctions.net';
  ...
  private sendRequest<T>(parameters: HttpParams = null) {
    ...
    return this.http.get<T>(this._URL + '/SalesforceKnowledgeSearch', options).pipe(catchError(this.handleError));
  }
